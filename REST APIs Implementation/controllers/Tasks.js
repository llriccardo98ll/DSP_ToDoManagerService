...
module.exports.assignTaskToUser = function assignTaskToUser (req, res, next, body, taskId) {
  Tasks.assignTaskToUser(body, taskId)
    .then(function (response) {
      utils.writeJson(res, response);
    })
    .catch(function (response) {
...
module.exports.getPublicTasks = function getPublicTasks (req, res, next, pageNo) {
...
module.exports.getUsersAssigned = function getUsersAssigned (req, res, next, taskId) {
...
module.exports.updateSingleTask = function updateSingleTask (req, res, next, body, taskId) {
